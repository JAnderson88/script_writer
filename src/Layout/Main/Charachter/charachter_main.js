...
//CSS
import './charachter_main.css';

function CharachterMain() {
  ...
  const getSuggestions = async () => {
    ...
    const plotSuggestions = tempSuggestions.filter(suggestion => suggestion.classification === 'charachter');
